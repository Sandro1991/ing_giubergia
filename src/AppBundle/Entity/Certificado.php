...
class Certificado
{
     ...
     * Set idOblea
     *
     * @param \AppBundle\Entity\Oblea $idOblea
     *
     * @return Certificado
     */
    public function setIdOblea(\AppBundle\Entity\Oblea $idOblea = null)
    {

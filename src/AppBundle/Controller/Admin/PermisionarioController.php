 ...
 */
class PermisionarioController extends BaseAdminController
{
    /**
    ...
    protected function createSearchQueryBuilder($entityClass, $searchQuery, array $searchableFields, $sortField = null, $sortDirection = null, $dqlFilter = null)
    {
        ...
        $queryBuilder = $em->createQueryBuilder()
            ...
            ->orWhere('LOWER(entity.nombPermi) LIKE :query')
            ->orWhere('LOWER(entity.dniPermi) LIKE :query')
            ->orWhere('LOWER(entity.direPermi) LIKE :query')
